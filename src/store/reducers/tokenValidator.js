...
let tokenReducer=(state=initialState,actions)=>{
    ...
    switch(actions.type)
    {
        case actionTypes.START_TOKEN_VALIDATION:return{...state,loading:true,error:null};
        case actionTypes.TOKEN_VALIDATION_SUCCESS: return{...state,token:actions.payload.token,error:null,loading:false};
